...
#ifndef _FM_DRIVER_LM_H
#define _FM_DRIVER_LM_H
...
INT32  FLM_Init             (void);
INT32  FLM_Open             (UINT16 chip);
INT32  FLM_Close            (UINT16 chip);
INT32  FLM_Read_Page        (UINT16 chip, UINT32 block, UINT16 page,
                             UINT16 sector_offset, UINT16 num_sectors,
                             UINT8 *dbuf, UINT8 *sbuf);
INT32  FLM_Read_Page_Group  (UINT16 chip, UINT32 *block, UINT16 page,
                             UINT8 *dbuf_group[], UINT8 *sbuf_group[],
                             INT32 *flag);
INT32  FLM_Write_Page       (UINT16 chip, UINT32 block, UINT16 page,
                             UINT16 sector_offset, UINT16 num_sectors,
                             UINT8 *dbuf, UINT8 *sbuf, BOOL is_last);
INT32  FLM_Write_Page_Group (UINT16 chip, UINT32 *block, UINT16 page,
                             UINT8 *dbuf_group[], UINT8 *sbuf_group[],
                             INT32 *flag, BOOL is_last);
INT32  FLM_Copy_Back        (UINT16 chip, UINT32 src_block, UINT16 src_page,
                             UINT32 dest_block, UINT16 dest_page);
INT32  FLM_Copy_Back_Group  (UINT16 chip, 
                             UINT32 *src_block, UINT16 *src_page, 
                             UINT32 *dest_block, UINT16 dest_page, 
                             INT32 *flag);
INT32  FLM_Erase            (UINT16 chip, UINT32 block);
INT32  FLM_Erase_Group      (UINT16 chip, UINT32 *block, INT32 *flag);
INT32  FLM_Sync             (UINT16 chip);
BOOL   FLM_IsBadBlock       (UINT16 chip, UINT32 block);
INT32  FLM_Read_ID          (UINT16 chip, UINT8 *maker, UINT8 *dev_code);

#endif /* _FM_DRIVER_LM_H */
