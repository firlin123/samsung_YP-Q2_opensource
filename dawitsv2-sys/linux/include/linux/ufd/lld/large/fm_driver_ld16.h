...
#ifndef _FM_DRIVER_LD16_H
#define _FM_DRIVER_LD16_H
...
INT32  FLD16_Init           (void);
INT32  FLD16_Open           (UINT16 chip);
INT32  FLD16_Close          (UINT16 chip);
INT32  FLD16_Read_Page      (UINT16 chip, UINT32 block, UINT16 page,
                             UINT16 sector_offset, UINT16 num_sectors,
                             UINT8 *dbuf, UINT8 *sbuf);
INT32  FLD16_Write_Page     (UINT16 chip, UINT32 block, UINT16 page,
                             UINT16 sector_offset, UINT16 num_sectors,
                             UINT8 *dbuf, UINT8 *sbuf, BOOL is_last);
INT32  FLD16_Copy_Back      (UINT16 chip, UINT32 src_block, UINT16 src_page,
                             UINT32 dest_block, UINT16 dest_page);
INT32  FLD16_Erase          (UINT16 chip, UINT32 block);
INT32  FLD16_Sync           (UINT16 chip);
BOOL   FLD16_IsBadBlock     (UINT16 chip, UINT32 block);
INT32  FLD16_Read_ID        (UINT16 chip, UINT8 *maker, UINT8 *dev_code);

#endif /* _FM_DRIVER_LD16_H */

/* end of fm_driver_ld16.h */
