...
// Filename: regsi2c.h
//
// Description: PIO Registers for I2C interface
//
// Xml Revision: 1.54
//
// Template revision: 908
//
////////////////////////////////////////////////////////////////////////////////
//
...
#define BM_I2C_DEBUG1_CLK_GEN_STATE      0x007F0000
...
#define BM_I2C_DEBUG1_FORCE_CLK_ON      0x00000020

#define BF_I2C_DEBUG1_FORCE_CLK_ON(v)   (((v) << 5) & BM_I2C_DEBUG1_FORCE_CLK_ON)

#ifndef __LANGUAGE_ASM__
#define BW_I2C_DEBUG1_FORCE_CLK_ON(v)   BF_CS1(I2C_DEBUG1, FORCE_CLK_ON, v)
#endif

//--- Register HW_I2C_DEBUG1, field FORCE_CLK_IDLE

#define BP_I2C_DEBUG1_FORCE_CLK_IDLE      4
#define BM_I2C_DEBUG1_FORCE_CLK_IDLE      0x00000010

#define BF_I2C_DEBUG1_FORCE_CLK_IDLE(v)   (((v) << 4) & BM_I2C_DEBUG1_FORCE_CLK_IDLE)

#ifndef __LANGUAGE_ASM__
#define BW_I2C_DEBUG1_FORCE_CLK_IDLE(v)   BF_CS1(I2C_DEBUG1, FORCE_CLK_IDLE, v)
#endif
