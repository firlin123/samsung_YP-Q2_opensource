////////////////////////////////////////////////////////////////////////////////
//
// Filename: regsaudioout.h
//
// Description: PIO Registers for AUDIOOUT interface
//
// Xml Revision: 1.65
//
...
//--- Register HW_AUDIOOUT_PWRDN, field LINEOUT
...
//--- Register HW_AUDIOOUT_TEST, field TM_LINEOUT

#define BP_AUDIOOUT_TEST_TM_LINEOUT      25
#define BM_AUDIOOUT_TEST_TM_LINEOUT      0x02000000

#define BF_AUDIOOUT_TEST_TM_LINEOUT(v)   (((v) << 25) & BM_AUDIOOUT_TEST_TM_LINEOUT)

#ifndef __LANGUAGE_ASM__
#define BW_AUDIOOUT_TEST_TM_LINEOUT(v)   BF_CS1(AUDIOOUT_TEST, TM_LINEOUT, v)
#endif
...
////////////////////////////////////////////////////////////////////////////////
//// HW_AUDIOOUT_LINEOUTCTRL - AUDIOOUT Line Out Control Register
////////////////////////////////////////////////////////////////////////////////
...
//
// constants & macros for entire HW_AUDIOOUT_LINEOUTCTRL register
//
...
//
// constants & macros for individual HW_AUDIOOUT_LINEOUTCTRL bitfields
//

//--- Register HW_AUDIOOUT_LINEOUTCTRL, field VOLUME_UPDATE_PENDING

#define BP_AUDIOOUT_LINEOUTCTRL_VOLUME_UPDATE_PENDING      28
#define BM_AUDIOOUT_LINEOUTCTRL_VOLUME_UPDATE_PENDING      0x10000000

#define BF_AUDIOOUT_LINEOUTCTRL_VOLUME_UPDATE_PENDING(v)   (((v) << 28) & BM_AUDIOOUT_LINEOUTCTRL_VOLUME_UPDATE_PENDING)

//--- Register HW_AUDIOOUT_LINEOUTCTRL, field EN_LINEOUT_ZCD

#define BP_AUDIOOUT_LINEOUTCTRL_EN_LINEOUT_ZCD      25
#define BM_AUDIOOUT_LINEOUTCTRL_EN_LINEOUT_ZCD      0x02000000

#define BF_AUDIOOUT_LINEOUTCTRL_EN_LINEOUT_ZCD(v)   (((v) << 25) & BM_AUDIOOUT_LINEOUTCTRL_EN_LINEOUT_ZCD)

#ifndef __LANGUAGE_ASM__
#define BW_AUDIOOUT_LINEOUTCTRL_EN_LINEOUT_ZCD(v)   BF_CS1(AUDIOOUT_LINEOUTCTRL, EN_LINEOUT_ZCD, v)
#endif

//--- Register HW_AUDIOOUT_LINEOUTCTRL, field MUTE

#define BP_AUDIOOUT_LINEOUTCTRL_MUTE      24
#define BM_AUDIOOUT_LINEOUTCTRL_MUTE      0x01000000

#define BF_AUDIOOUT_LINEOUTCTRL_MUTE(v)   (((v) << 24) & BM_AUDIOOUT_LINEOUTCTRL_MUTE)

#ifndef __LANGUAGE_ASM__
#define BW_AUDIOOUT_LINEOUTCTRL_MUTE(v)   BF_CS1(AUDIOOUT_LINEOUTCTRL, MUTE, v)
#endif

//--- Register HW_AUDIOOUT_LINEOUTCTRL, field VAG_CTRL

#define BP_AUDIOOUT_LINEOUTCTRL_VAG_CTRL      20
#define BM_AUDIOOUT_LINEOUTCTRL_VAG_CTRL      0x00F00000

#define BF_AUDIOOUT_LINEOUTCTRL_VAG_CTRL(v)   (((v) << 20) & BM_AUDIOOUT_LINEOUTCTRL_VAG_CTRL)

#ifndef __LANGUAGE_ASM__
#define BW_AUDIOOUT_LINEOUTCTRL_VAG_CTRL(v)   BF_CS1(AUDIOOUT_LINEOUTCTRL, VAG_CTRL, v)
#endif

//--- Register HW_AUDIOOUT_LINEOUTCTRL, field OUT_CURRENT

#define BP_AUDIOOUT_LINEOUTCTRL_OUT_CURRENT      16
#define BM_AUDIOOUT_LINEOUTCTRL_OUT_CURRENT      0x000F0000

#define BF_AUDIOOUT_LINEOUTCTRL_OUT_CURRENT(v)   (((v) << 16) & BM_AUDIOOUT_LINEOUTCTRL_OUT_CURRENT)

#ifndef __LANGUAGE_ASM__
#define BW_AUDIOOUT_LINEOUTCTRL_OUT_CURRENT(v)   BF_CS1(AUDIOOUT_LINEOUTCTRL, OUT_CURRENT, v)
#endif

//--- Register HW_AUDIOOUT_LINEOUTCTRL, field CHARGE_CAP

#define BP_AUDIOOUT_LINEOUTCTRL_CHARGE_CAP      13
#define BM_AUDIOOUT_LINEOUTCTRL_CHARGE_CAP      0x0000E000

#define BF_AUDIOOUT_LINEOUTCTRL_CHARGE_CAP(v)   (((v) << 13) & BM_AUDIOOUT_LINEOUTCTRL_CHARGE_CAP)

#ifndef __LANGUAGE_ASM__
#define BW_AUDIOOUT_LINEOUTCTRL_CHARGE_CAP(v)   BF_CS1(AUDIOOUT_LINEOUTCTRL, CHARGE_CAP, v)
#endif

//--- Register HW_AUDIOOUT_LINEOUTCTRL, field VOLUME_LEFT

#define BP_AUDIOOUT_LINEOUTCTRL_VOLUME_LEFT      8
#define BM_AUDIOOUT_LINEOUTCTRL_VOLUME_LEFT      0x00001F00

#define BF_AUDIOOUT_LINEOUTCTRL_VOLUME_LEFT(v)   (((v) << 8) & BM_AUDIOOUT_LINEOUTCTRL_VOLUME_LEFT)

#ifndef __LANGUAGE_ASM__
#define BW_AUDIOOUT_LINEOUTCTRL_VOLUME_LEFT(v)   BF_CS1(AUDIOOUT_LINEOUTCTRL, VOLUME_LEFT, v)
#endif

//--- Register HW_AUDIOOUT_LINEOUTCTRL, field VOLUME_RIGHT

#define BP_AUDIOOUT_LINEOUTCTRL_VOLUME_RIGHT      0
#define BM_AUDIOOUT_LINEOUTCTRL_VOLUME_RIGHT      0x0000001F

#define BF_AUDIOOUT_LINEOUTCTRL_VOLUME_RIGHT(v)   (((v) << 0) & BM_AUDIOOUT_LINEOUTCTRL_VOLUME_RIGHT)

#ifndef __LANGUAGE_ASM__
#define BW_AUDIOOUT_LINEOUTCTRL_VOLUME_RIGHT(v)   BF_CS1(AUDIOOUT_LINEOUTCTRL, VOLUME_RIGHT, v)
#endif
