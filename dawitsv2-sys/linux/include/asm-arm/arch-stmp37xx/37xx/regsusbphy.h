...
//--- Register HW_USBPHY_PWD, field TXPWDCOMP

#define BP_USBPHY_PWD_TXPWDCOMP      14
#define BM_USBPHY_PWD_TXPWDCOMP      0x00004000

#define BF_USBPHY_PWD_TXPWDCOMP(v)   (((v) << 14) & BM_USBPHY_PWD_TXPWDCOMP)

#ifndef __LANGUAGE_ASM__
#define BW_USBPHY_PWD_TXPWDCOMP(v)   BF_CS1(USBPHY_PWD, TXPWDCOMP, v)
#endif

//--- Register HW_USBPHY_PWD, field TXPWDVBG

#define BP_USBPHY_PWD_TXPWDVBG      13
#define BM_USBPHY_PWD_TXPWDVBG      0x00002000

#define BF_USBPHY_PWD_TXPWDVBG(v)   (((v) << 13) & BM_USBPHY_PWD_TXPWDVBG)

#ifndef __LANGUAGE_ASM__
#define BW_USBPHY_PWD_TXPWDVBG(v)   BF_CS1(USBPHY_PWD, TXPWDVBG, v)
#endif
...
//--- Register HW_USBPHY_TX, field TXCMPOUT_STATUS

#define BP_USBPHY_TX_TXCMPOUT_STATUS      23
#define BM_USBPHY_TX_TXCMPOUT_STATUS      0x00800000

#define BF_USBPHY_TX_TXCMPOUT_STATUS(v)   (((v) << 23) & BM_USBPHY_TX_TXCMPOUT_STATUS)

#ifndef __LANGUAGE_ASM__
#define BW_USBPHY_TX_TXCMPOUT_STATUS(v)   BF_CS1(USBPHY_TX, TXCMPOUT_STATUS, v)
#endif
...
//--- Register HW_USBPHY_TX, field TXCALIBRATE

#define BP_USBPHY_TX_TXCALIBRATE      7
#define BM_USBPHY_TX_TXCALIBRATE      0x00000080

#define BF_USBPHY_TX_TXCALIBRATE(v)   (((v) << 7) & BM_USBPHY_TX_TXCALIBRATE)

#ifndef __LANGUAGE_ASM__
#define BW_USBPHY_TX_TXCALIBRATE(v)   BF_CS1(USBPHY_TX, TXCALIBRATE, v)
#endif
...
#define BM_USBPHY_RX_DISCONADJ      0x00000030
...
#define BM_USBPHY_RX_ENVADJ      0x00000003
...
//--- Register HW_USBPHY_CTRL, field ENHSPRECHARGEXMIT

#define BP_USBPHY_CTRL_ENHSPRECHARGEXMIT      0
#define BM_USBPHY_CTRL_ENHSPRECHARGEXMIT      0x00000001

#define BF_USBPHY_CTRL_ENHSPRECHARGEXMIT(v)   (((v) << 0) & BM_USBPHY_CTRL_ENHSPRECHARGEXMIT)

#ifndef __LANGUAGE_ASM__
#define BW_USBPHY_CTRL_ENHSPRECHARGEXMIT(v)   BF_CS1(USBPHY_CTRL, ENHSPRECHARGEXMIT, v)
#endif
...
//--- Register HW_USBPHY_DEBUG1, field PLL_IS_240

#define BP_USBPHY_DEBUG1_PLL_IS_240      8
#define BM_USBPHY_DEBUG1_PLL_IS_240      0x00000100

#define BF_USBPHY_DEBUG1_PLL_IS_240(v)   (((v) << 8) & BM_USBPHY_DEBUG1_PLL_IS_240)

#ifndef __LANGUAGE_ASM__
#define BW_USBPHY_DEBUG1_PLL_IS_240(v)   BF_CS1(USBPHY_DEBUG1, PLL_IS_240, v)
#endif
