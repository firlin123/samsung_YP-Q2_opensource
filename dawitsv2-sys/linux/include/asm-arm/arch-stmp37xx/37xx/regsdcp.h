...
// Filename: regsdcp.h
//
// Description: PIO Registers for DCP interface
//
// Xml Revision: 1.57
//
...
#define BV_DCP_CTRL_CHANNEL_INTERRUPT_ENABLE__Other  Reserved
...
#define BV_DCP_STAT_CUR_CHANNEL__Other  Reserved
...
#define BV_DCP_STAT_READY_CHANNELS__Other  Reserved
...
#define BV_DCP_CHANNELCTRL_HIGH_PRIORITY_CHANNEL__Other  Reserved
...
#define BV_DCP_CHANNELCTRL_ENABLE_CHANNEL__Other  Reserved
...
typedef union
{
	...
	/** Renamed from "KEY_SELECT" to avoid clash */
        reg8_t   CIPHER_KEY_SELECT;
...
#define BV_DCP_PACKET2_CIPHER_MODE__CCB  0x01
...
#define BV_DCP_DBGSELECT_INDEX__Other    Reserved
...
#define HW_DCP_VERSION_ADDR      (REGS_DCP_BASE + 0x00000420)
