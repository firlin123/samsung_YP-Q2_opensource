////////////////////////////////////////////////////////////////////////////////
//
// Filename: regsuartapp.h
//
// Description: PIO Registers for UARTAPP interface
//
// Xml Revision: 1.42
//
...
#ifndef _REGSUARTAPP_H
#define _REGSUARTAPP_H  1
...
//
// constants & macros for entire HW_UARTAPP_CTRL0 register
//

#define HW_UARTAPP_CTRL0_ADDR      (REGS_UARTAPP_BASE + 0x00000000)
#define HW_UARTAPP_CTRL0_SET_ADDR  (REGS_UARTAPP_BASE + 0x00000004)
#define HW_UARTAPP_CTRL0_CLR_ADDR  (REGS_UARTAPP_BASE + 0x00000008)
#define HW_UARTAPP_CTRL0_TOG_ADDR  (REGS_UARTAPP_BASE + 0x0000000C)

#ifndef __LANGUAGE_ASM__
#define HW_UARTAPP_CTRL0           (*(volatile hw_uartapp_ctrl0_t *) HW_UARTAPP_CTRL0_ADDR)
#define HW_UARTAPP_CTRL0_RD()      (HW_UARTAPP_CTRL0.U)
#define HW_UARTAPP_CTRL0_WR(v)     (HW_UARTAPP_CTRL0.U = (v))
#define HW_UARTAPP_CTRL0_SET(v)    ((*(volatile reg32_t *) HW_UARTAPP_CTRL0_SET_ADDR) = (v))
#define HW_UARTAPP_CTRL0_CLR(v)    ((*(volatile reg32_t *) HW_UARTAPP_CTRL0_CLR_ADDR) = (v))
#define HW_UARTAPP_CTRL0_TOG(v)    ((*(volatile reg32_t *) HW_UARTAPP_CTRL0_TOG_ADDR) = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_CTRL0_SFTRST(v)   BF_CS1(UARTAPP_CTRL0, SFTRST, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_CTRL0_CLKGATE(v)   BF_CS1(UARTAPP_CTRL0, CLKGATE, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_CTRL0_RUN(v)   BF_CS1(UARTAPP_CTRL0, RUN, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_CTRL0_RX_SOURCE(v)   BF_CS1(UARTAPP_CTRL0, RX_SOURCE, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_CTRL0_RXTO_ENABLE(v)   BF_CS1(UARTAPP_CTRL0, RXTO_ENABLE, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_CTRL0_RXTIMEOUT(v)   BF_CS1(UARTAPP_CTRL0, RXTIMEOUT, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_CTRL0_XFER_COUNT(v)   (HW_UARTAPP_CTRL0.B.XFER_COUNT = (v))
#endif
...
//
// constants & macros for entire HW_UARTAPP_CTRL1 register
//

#define HW_UARTAPP_CTRL1_ADDR      (REGS_UARTAPP_BASE + 0x00000010)
#define HW_UARTAPP_CTRL1_SET_ADDR  (REGS_UARTAPP_BASE + 0x00000014)
#define HW_UARTAPP_CTRL1_CLR_ADDR  (REGS_UARTAPP_BASE + 0x00000018)
#define HW_UARTAPP_CTRL1_TOG_ADDR  (REGS_UARTAPP_BASE + 0x0000001C)

#ifndef __LANGUAGE_ASM__
#define HW_UARTAPP_CTRL1           (*(volatile hw_uartapp_ctrl1_t *) HW_UARTAPP_CTRL1_ADDR)
#define HW_UARTAPP_CTRL1_RD()      (HW_UARTAPP_CTRL1.U)
#define HW_UARTAPP_CTRL1_WR(v)     (HW_UARTAPP_CTRL1.U = (v))
#define HW_UARTAPP_CTRL1_SET(v)    ((*(volatile reg32_t *) HW_UARTAPP_CTRL1_SET_ADDR) = (v))
#define HW_UARTAPP_CTRL1_CLR(v)    ((*(volatile reg32_t *) HW_UARTAPP_CTRL1_CLR_ADDR) = (v))
#define HW_UARTAPP_CTRL1_TOG(v)    ((*(volatile reg32_t *) HW_UARTAPP_CTRL1_TOG_ADDR) = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_CTRL1_RUN(v)   BF_CS1(UARTAPP_CTRL1, RUN, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_CTRL1_XFER_COUNT(v)   (HW_UARTAPP_CTRL1.B.XFER_COUNT = (v))
#endif
...
//
// constants & macros for entire HW_UARTAPP_CTRL2 register
//

#define HW_UARTAPP_CTRL2_ADDR      (REGS_UARTAPP_BASE + 0x00000020)
#define HW_UARTAPP_CTRL2_SET_ADDR  (REGS_UARTAPP_BASE + 0x00000024)
#define HW_UARTAPP_CTRL2_CLR_ADDR  (REGS_UARTAPP_BASE + 0x00000028)
#define HW_UARTAPP_CTRL2_TOG_ADDR  (REGS_UARTAPP_BASE + 0x0000002C)

#ifndef __LANGUAGE_ASM__
#define HW_UARTAPP_CTRL2           (*(volatile hw_uartapp_ctrl2_t *) HW_UARTAPP_CTRL2_ADDR)
#define HW_UARTAPP_CTRL2_RD()      (HW_UARTAPP_CTRL2.U)
#define HW_UARTAPP_CTRL2_WR(v)     (HW_UARTAPP_CTRL2.U = (v))
#define HW_UARTAPP_CTRL2_SET(v)    ((*(volatile reg32_t *) HW_UARTAPP_CTRL2_SET_ADDR) = (v))
#define HW_UARTAPP_CTRL2_CLR(v)    ((*(volatile reg32_t *) HW_UARTAPP_CTRL2_CLR_ADDR) = (v))
#define HW_UARTAPP_CTRL2_TOG(v)    ((*(volatile reg32_t *) HW_UARTAPP_CTRL2_TOG_ADDR) = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_CTRL2_INVERT_RTS(v)   BF_CS1(UARTAPP_CTRL2, INVERT_RTS, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_CTRL2_INVERT_CTS(v)   BF_CS1(UARTAPP_CTRL2, INVERT_CTS, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_CTRL2_INVERT_TX(v)   BF_CS1(UARTAPP_CTRL2, INVERT_TX, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_CTRL2_INVERT_RX(v)   BF_CS1(UARTAPP_CTRL2, INVERT_RX, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_CTRL2_RTS_SEMAPHORE(v)   BF_CS1(UARTAPP_CTRL2, RTS_SEMAPHORE, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_CTRL2_DMAONERR(v)   BF_CS1(UARTAPP_CTRL2, DMAONERR, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_CTRL2_TXDMAE(v)   BF_CS1(UARTAPP_CTRL2, TXDMAE, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_CTRL2_RXDMAE(v)   BF_CS1(UARTAPP_CTRL2, RXDMAE, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_CTRL2_RXIFLSEL(v)   BF_CS1(UARTAPP_CTRL2, RXIFLSEL, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_CTRL2_TXIFLSEL(v)   BF_CS1(UARTAPP_CTRL2, TXIFLSEL, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_CTRL2_CTSEN(v)   BF_CS1(UARTAPP_CTRL2, CTSEN, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_CTRL2_RTSEN(v)   BF_CS1(UARTAPP_CTRL2, RTSEN, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_CTRL2_OUT2(v)   BF_CS1(UARTAPP_CTRL2, OUT2, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_CTRL2_OUT1(v)   BF_CS1(UARTAPP_CTRL2, OUT1, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_CTRL2_RTS(v)   BF_CS1(UARTAPP_CTRL2, RTS, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_CTRL2_DTR(v)   BF_CS1(UARTAPP_CTRL2, DTR, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_CTRL2_RXE(v)   BF_CS1(UARTAPP_CTRL2, RXE, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_CTRL2_TXE(v)   BF_CS1(UARTAPP_CTRL2, TXE, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_CTRL2_LBE(v)   BF_CS1(UARTAPP_CTRL2, LBE, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_CTRL2_USE_LCR2(v)   BF_CS1(UARTAPP_CTRL2, USE_LCR2, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_CTRL2_SIRLP(v)   BF_CS1(UARTAPP_CTRL2, SIRLP, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_CTRL2_SIREN(v)   BF_CS1(UARTAPP_CTRL2, SIREN, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_CTRL2_UARTEN(v)   BF_CS1(UARTAPP_CTRL2, UARTEN, v)
#endif
...
//
// constants & macros for entire HW_UARTAPP_LINECTRL register
//

#define HW_UARTAPP_LINECTRL_ADDR      (REGS_UARTAPP_BASE + 0x00000030)
#define HW_UARTAPP_LINECTRL_SET_ADDR  (REGS_UARTAPP_BASE + 0x00000034)
#define HW_UARTAPP_LINECTRL_CLR_ADDR  (REGS_UARTAPP_BASE + 0x00000038)
#define HW_UARTAPP_LINECTRL_TOG_ADDR  (REGS_UARTAPP_BASE + 0x0000003C)

#ifndef __LANGUAGE_ASM__
#define HW_UARTAPP_LINECTRL           (*(volatile hw_uartapp_linectrl_t *) HW_UARTAPP_LINECTRL_ADDR)
#define HW_UARTAPP_LINECTRL_RD()      (HW_UARTAPP_LINECTRL.U)
#define HW_UARTAPP_LINECTRL_WR(v)     (HW_UARTAPP_LINECTRL.U = (v))
#define HW_UARTAPP_LINECTRL_SET(v)    ((*(volatile reg32_t *) HW_UARTAPP_LINECTRL_SET_ADDR) = (v))
#define HW_UARTAPP_LINECTRL_CLR(v)    ((*(volatile reg32_t *) HW_UARTAPP_LINECTRL_CLR_ADDR) = (v))
#define HW_UARTAPP_LINECTRL_TOG(v)    ((*(volatile reg32_t *) HW_UARTAPP_LINECTRL_TOG_ADDR) = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_LINECTRL_BAUD_DIVINT(v)   (HW_UARTAPP_LINECTRL.B.BAUD_DIVINT = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_LINECTRL_BAUD_DIVFRAC(v)   BF_CS1(UARTAPP_LINECTRL, BAUD_DIVFRAC, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_LINECTRL_SPS(v)   BF_CS1(UARTAPP_LINECTRL, SPS, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_LINECTRL_WLEN(v)   BF_CS1(UARTAPP_LINECTRL, WLEN, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_LINECTRL_FEN(v)   BF_CS1(UARTAPP_LINECTRL, FEN, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_LINECTRL_STP2(v)   BF_CS1(UARTAPP_LINECTRL, STP2, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_LINECTRL_EPS(v)   BF_CS1(UARTAPP_LINECTRL, EPS, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_LINECTRL_PEN(v)   BF_CS1(UARTAPP_LINECTRL, PEN, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_LINECTRL_BRK(v)   BF_CS1(UARTAPP_LINECTRL, BRK, v)
#endif
...
//
// constants & macros for entire HW_UARTAPP_LINECTRL2 register
//

#define HW_UARTAPP_LINECTRL2_ADDR      (REGS_UARTAPP_BASE + 0x00000040)
#define HW_UARTAPP_LINECTRL2_SET_ADDR  (REGS_UARTAPP_BASE + 0x00000044)
#define HW_UARTAPP_LINECTRL2_CLR_ADDR  (REGS_UARTAPP_BASE + 0x00000048)
#define HW_UARTAPP_LINECTRL2_TOG_ADDR  (REGS_UARTAPP_BASE + 0x0000004C)

#ifndef __LANGUAGE_ASM__
#define HW_UARTAPP_LINECTRL2           (*(volatile hw_uartapp_linectrl2_t *) HW_UARTAPP_LINECTRL2_ADDR)
#define HW_UARTAPP_LINECTRL2_RD()      (HW_UARTAPP_LINECTRL2.U)
#define HW_UARTAPP_LINECTRL2_WR(v)     (HW_UARTAPP_LINECTRL2.U = (v))
#define HW_UARTAPP_LINECTRL2_SET(v)    ((*(volatile reg32_t *) HW_UARTAPP_LINECTRL2_SET_ADDR) = (v))
#define HW_UARTAPP_LINECTRL2_CLR(v)    ((*(volatile reg32_t *) HW_UARTAPP_LINECTRL2_CLR_ADDR) = (v))
#define HW_UARTAPP_LINECTRL2_TOG(v)    ((*(volatile reg32_t *) HW_UARTAPP_LINECTRL2_TOG_ADDR) = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_LINECTRL2_BAUD_DIVINT(v)   (HW_UARTAPP_LINECTRL2.B.BAUD_DIVINT = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_LINECTRL2_BAUD_DIVFRAC(v)   BF_CS1(UARTAPP_LINECTRL2, BAUD_DIVFRAC, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_LINECTRL2_SPS(v)   BF_CS1(UARTAPP_LINECTRL2, SPS, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_LINECTRL2_WLEN(v)   BF_CS1(UARTAPP_LINECTRL2, WLEN, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_LINECTRL2_FEN(v)   BF_CS1(UARTAPP_LINECTRL2, FEN, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_LINECTRL2_STP2(v)   BF_CS1(UARTAPP_LINECTRL2, STP2, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_LINECTRL2_EPS(v)   BF_CS1(UARTAPP_LINECTRL2, EPS, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_LINECTRL2_PEN(v)   BF_CS1(UARTAPP_LINECTRL2, PEN, v)
#endif
...
//
// constants & macros for entire HW_UARTAPP_INTR register
//

#define HW_UARTAPP_INTR_ADDR      (REGS_UARTAPP_BASE + 0x00000050)
#define HW_UARTAPP_INTR_SET_ADDR  (REGS_UARTAPP_BASE + 0x00000054)
#define HW_UARTAPP_INTR_CLR_ADDR  (REGS_UARTAPP_BASE + 0x00000058)
#define HW_UARTAPP_INTR_TOG_ADDR  (REGS_UARTAPP_BASE + 0x0000005C)

#ifndef __LANGUAGE_ASM__
#define HW_UARTAPP_INTR           (*(volatile hw_uartapp_intr_t *) HW_UARTAPP_INTR_ADDR)
#define HW_UARTAPP_INTR_RD()      (HW_UARTAPP_INTR.U)
#define HW_UARTAPP_INTR_WR(v)     (HW_UARTAPP_INTR.U = (v))
#define HW_UARTAPP_INTR_SET(v)    ((*(volatile reg32_t *) HW_UARTAPP_INTR_SET_ADDR) = (v))
#define HW_UARTAPP_INTR_CLR(v)    ((*(volatile reg32_t *) HW_UARTAPP_INTR_CLR_ADDR) = (v))
#define HW_UARTAPP_INTR_TOG(v)    ((*(volatile reg32_t *) HW_UARTAPP_INTR_TOG_ADDR) = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_INTR_OEIEN(v)   BF_CS1(UARTAPP_INTR, OEIEN, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_INTR_BEIEN(v)   BF_CS1(UARTAPP_INTR, BEIEN, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_INTR_PEIEN(v)   BF_CS1(UARTAPP_INTR, PEIEN, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_INTR_FEIEN(v)   BF_CS1(UARTAPP_INTR, FEIEN, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_INTR_RTIEN(v)   BF_CS1(UARTAPP_INTR, RTIEN, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_INTR_TXIEN(v)   BF_CS1(UARTAPP_INTR, TXIEN, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_INTR_RXIEN(v)   BF_CS1(UARTAPP_INTR, RXIEN, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_INTR_DSRMIEN(v)   BF_CS1(UARTAPP_INTR, DSRMIEN, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_INTR_DCDMIEN(v)   BF_CS1(UARTAPP_INTR, DCDMIEN, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_INTR_CTSMIEN(v)   BF_CS1(UARTAPP_INTR, CTSMIEN, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_INTR_RIMIEN(v)   BF_CS1(UARTAPP_INTR, RIMIEN, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_INTR_OEIS(v)   BF_CS1(UARTAPP_INTR, OEIS, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_INTR_BEIS(v)   BF_CS1(UARTAPP_INTR, BEIS, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_INTR_PEIS(v)   BF_CS1(UARTAPP_INTR, PEIS, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_INTR_FEIS(v)   BF_CS1(UARTAPP_INTR, FEIS, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_INTR_RTIS(v)   BF_CS1(UARTAPP_INTR, RTIS, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_INTR_TXIS(v)   BF_CS1(UARTAPP_INTR, TXIS, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_INTR_RXIS(v)   BF_CS1(UARTAPP_INTR, RXIS, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_INTR_DSRMIS(v)   BF_CS1(UARTAPP_INTR, DSRMIS, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_INTR_DCDMIS(v)   BF_CS1(UARTAPP_INTR, DCDMIS, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_INTR_CTSMIS(v)   BF_CS1(UARTAPP_INTR, CTSMIS, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_INTR_RIMIS(v)   BF_CS1(UARTAPP_INTR, RIMIS, v)
#endif
...
//
// constants & macros for entire HW_UARTAPP_DATA register
//

#define HW_UARTAPP_DATA_ADDR      (REGS_UARTAPP_BASE + 0x00000060)

#ifndef __LANGUAGE_ASM__
#define HW_UARTAPP_DATA           (*(volatile hw_uartapp_data_t *) HW_UARTAPP_DATA_ADDR)
#define HW_UARTAPP_DATA_RD()      (HW_UARTAPP_DATA.U)
#define HW_UARTAPP_DATA_WR(v)     (HW_UARTAPP_DATA.U = (v))
#define HW_UARTAPP_DATA_SET(v)    (HW_UARTAPP_DATA_WR(HW_UARTAPP_DATA_RD() |  (v)))
#define HW_UARTAPP_DATA_CLR(v)    (HW_UARTAPP_DATA_WR(HW_UARTAPP_DATA_RD() & ~(v)))
#define HW_UARTAPP_DATA_TOG(v)    (HW_UARTAPP_DATA_WR(HW_UARTAPP_DATA_RD() ^  (v)))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_DATA_DATA(v)   (HW_UARTAPP_DATA.B.DATA = (v))
#endif
...
//
// constants & macros for entire HW_UARTAPP_STAT register
//

#define HW_UARTAPP_STAT_ADDR      (REGS_UARTAPP_BASE + 0x00000070)

#ifndef __LANGUAGE_ASM__
#define HW_UARTAPP_STAT           (*(volatile hw_uartapp_stat_t *) HW_UARTAPP_STAT_ADDR)
#define HW_UARTAPP_STAT_RD()      (HW_UARTAPP_STAT.U)
#define HW_UARTAPP_STAT_WR(v)     (HW_UARTAPP_STAT.U = (v))
#define HW_UARTAPP_STAT_SET(v)    (HW_UARTAPP_STAT_WR(HW_UARTAPP_STAT_RD() |  (v)))
#define HW_UARTAPP_STAT_CLR(v)    (HW_UARTAPP_STAT_WR(HW_UARTAPP_STAT_RD() & ~(v)))
#define HW_UARTAPP_STAT_TOG(v)    (HW_UARTAPP_STAT_WR(HW_UARTAPP_STAT_RD() ^  (v)))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_STAT_RXBYTE_INVALID(v)   BF_CS1(UARTAPP_STAT, RXBYTE_INVALID, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_STAT_BERR(v)   BF_CS1(UARTAPP_STAT, BERR, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_STAT_PERR(v)   BF_CS1(UARTAPP_STAT, PERR, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_STAT_FERR(v)   BF_CS1(UARTAPP_STAT, FERR, v)
#endif
...
//
// constants & macros for entire HW_UARTAPP_DEBUG register
//

#define HW_UARTAPP_DEBUG_ADDR      (REGS_UARTAPP_BASE + 0x00000080)

#ifndef __LANGUAGE_ASM__
#define HW_UARTAPP_DEBUG           (*(volatile hw_uartapp_debug_t *) HW_UARTAPP_DEBUG_ADDR)
#define HW_UARTAPP_DEBUG_RD()      (HW_UARTAPP_DEBUG.U)
#endif
...
//
// constants & macros for entire HW_UARTAPP_VERSION register
//

#define HW_UARTAPP_VERSION_ADDR      (REGS_UARTAPP_BASE + 0x00000090)

#ifndef __LANGUAGE_ASM__
#define HW_UARTAPP_VERSION           (*(volatile hw_uartapp_version_t *) HW_UARTAPP_VERSION_ADDR)
#define HW_UARTAPP_VERSION_RD()      (HW_UARTAPP_VERSION.U)
#endif
