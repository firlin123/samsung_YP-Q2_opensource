...
typedef struct BufferDec 
{
	int RawDecoderMemory[44272 / 4];
}tBuffers;
    
// LIB version
WMARESULT WMARawDecInit (WMARawDecHandle *phWMARawDec, U16_WMARawDec iVersionNumber,
						 U16_WMARawDec cSamplesPerBlock, U16_WMARawDec cSamplesPerSecond, U16_WMARawDec cChannel,
						 U16_WMARawDec cBytePerSec, U16_WMARawDec cPacketLength, U16_WMARawDec cEncodeOpt);
...
WMARESULT WMARawDecDecodeData (WMARawDecHandle hWMARawDec, U8_WMARawDec *input_buffer, U32_WMARawDec *pnDecodedSamples);
...
extern U32_WMARawDec* WMARawDecGetInternalBuffer (WMARawDecHandle hWMARawDec);

// ROM Version
typedef struct decoder_fptr
{   
	int (*WMARawDecClose)(WMARawDecHandle* phWMARawDec);
	int (*WMARawDecStatus)(WMARawDecHandle hWMARawDec);
	int (*WMARawDecDecodeData)(WMARawDecHandle hWMARawDec, unsigned char *input_buffer, unsigned long *pnDecodedSamples);
	int (*WMARawDecReset)(WMARawDecHandle hWMARawDec);
	int (*WMARawDecInit)(WMARawDecHandle *phWMARawDec, U16_WMARawDec iVersionNumber,
						 U16_WMARawDec cSamplesPerBlock, U16_WMARawDec cSamplesPerSecond, U16_WMARawDec cChannel, 
						 U16_WMARawDec cBytePerSec, U16_WMARawDec cPacketLength, U16_WMARawDec cEncodeOpt);
	int (*WMARawData) (WMARawDecHandle *hWMARawDec, unsigned long DataPropertyObject);
	int (*WMARawDecGetPCM) (WMARawDecHandle hWMARawDec, U16_WMARawDec* pcSampleReady, 
						U8_WMARawDec* pbDst, U32_WMARawDec cbDstBufferLength);

	//int (*WMARawDecCBGetData) (U8_WMARawDec **ppBuffer, U32_WMARawDec *pcbBuffer, U32_WMARawDec dwUserData);
	int (*WMARawDecCBGetData) (U8_WMARawDec **ppBuffer, U32_WMARawDec *pcbBuffer);
